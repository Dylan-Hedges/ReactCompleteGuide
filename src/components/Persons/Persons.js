...
//Functional Component (dont need to manage state) - In ES6 if your function is on 1 line you can omit the return statement, no need for "=> { return( ); }", we dont need to wrap the code in () as its JS code
