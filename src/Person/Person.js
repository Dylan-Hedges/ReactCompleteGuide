...
const person = (props) => {
  //{props.name} - this is the syntax for functional components, for class-based components we use "this.props" (we use "props" and not "state" in functional components); {props.children} - reserved keyword, it returns whatever is inside our component tags "<Person> </Person>", this could be anything (even other React components)
  return (
    <div>
